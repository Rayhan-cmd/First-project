...
int main ()
{
 ...
 if(input==1) {
    ...
    printf("For Electricity Bill= Enter SMS Account number:/For Gas Bill=Input meter number:/For water Bill=Input Bill number:/For Internet or Telephone=Input phone Number with Area Code:   ");
    scanf("%d",&number);
    printf("Enter your amount:  ");
    scanf("%d",&amount);
